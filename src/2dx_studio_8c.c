...
THIS IS AN EDITED VERSION FOR THE DELIVERABLE 
*/
#include <stdint.h> 
#include <stdio.h>
#include "PLL.h"
...
void spinccw(){ //spins the motor clockwise
...
/* Those basic I2C read functions can be used to check your own I2C functions */
	...
	//sprintf(printf_buffer,"(Model_ID=0x%x, Module_Type=0x%x)=0x%x\r\n", myByteArray[0],myByteArray[1],wordData);
...
//	UART_printf("ToF Chip Booted!\r\n Please Wait...\r\n");
  ...
  status = VL53L1X_SensorInit(dev); //3
